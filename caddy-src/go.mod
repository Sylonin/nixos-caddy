...
require (
	...
	github.com/git001/caddyv2-upload v0.0.0-20240604074210-256822c5c8d1
	github.com/greenpau/caddy-appd v1.0.4
...
require (
	...
	github.com/crowdsecurity/go-cs-bouncer v0.0.12 // indirect
